...
module.exports = function (order) {
  ...
  sheet1.set(5, 6, "Fiyat");
  sheet1.font(5, 6, {name: 'name', bold: 'true'});
  sheet1.set(6, 6, "İskonto");
  ...
  workbook.save(function (ok) {
    ...
    if (!ok) {
      console.log('Excel başarılı bir şekilde oluşturuldu!');
      ...
      console.log('Excel oluşturulamadı!');
      workbook.cancel();
